...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{ route('admin.profile')}}" class="d-block admin_name">{{ Auth::user()->name }}
          </a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-compact nav-child-indent nav-collapse-hide-child nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="{{ route('admin.userview')}}" class="nav-link {{ (request()->is('admin/user*')) ? 'active' : '' }}">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024 <a href="#">superapp</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
