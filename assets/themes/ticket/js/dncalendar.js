		...
		*/
		var draw = function() {
                  ...
                  for (var i = 0; i < weekNameLength; i++) {
                  	tableHeadRowGroup.append("<td "+ ((i == 0) ? 'class=\"holiday\"' : '') +">"+ weekName[i] +"</td>");
                  }
      		...
      		if (maxDate != null) {
                  ...
                  if (settings.showNotes) {
	                ...
	                var m = currDate.getMonth(); // get month
	                var headerMonth = settings.monthNamesShort[m];
                        ...
                        if (notesLength > 0) {
                              ...
                              for (var i = 0; i < notesLength; i++) {
                                    ...
                                    var list = "";
                                    list += "<li class='date'>";
                                    list += "<span>"+ date +" "+ headerMonth +"</span> ";

                                    if (noteListLength > 0) {
                                          list += " : <span style='color:#445870;padding-left:10px;'>";
